...
@Component({
  selector: 'ingredient-provider',
  templateUrl: './ingredient-provider.component.html',
  styleUrls: ['./ingredient-provider.component.scss']
})
export class IngredientProviderComponent implements OnInit {
  ...
  getArticles() {  	//Gets ingredient's provider articles...
  // console.log(
  //   this.id, 
  //     this.itemsPerPage, 
  //     this.currentPage - 1,
  ...
  //     'consolelog')
    this.articleService.getArticles(
      ...
      (data: any) => {
        //console.log(data.articles, 'getArticles')
  ...
  viewArticle(id){
    ...
    this.compassService.saveRedirectData('articles/ingredients',this.id, '', 'view');
